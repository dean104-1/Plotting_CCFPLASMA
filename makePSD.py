...
for kk in range(len(cfg.tapnum_vec)):
    ...
    for ii in range(len(cfg.filenames_taps)):
        ...
        for nn in range(cfg.lengths_taps[ii]):
            ...
            rho_star.append(slices[nn]["Q"][cfg.tapnum_vec[kk],0,0,0])
            rho_star_u_star.append(slices[nn]["Q"][cfg.tapnum_vec[kk],0,0,1])
            rho_star_v_star.append(slices[nn]["Q"][cfg.tapnum_vec[kk],0,0,2])
            rho_star_w_star.append(slices[nn]["Q"][cfg.tapnum_vec[kk],0,0,3])
            rho_star_e_star.append(slices[nn]["Q"][cfg.tapnum_vec[kk],0,0,4])
